            ...
            <div className="header flex">
              <Link href="/abc">
                <a className="header-logo">
                  <Image
                    src="https://dsathemes.com/html/olmo_1.4/files/images/logo-01.png"
                ...
                <ul className="header-nav-list flex">
                  <li className="header-nav-item">
                    <Link href="/abc">
                      <a>
                        Home{" "}
                        <span className="icon header-icon-down">
                          <FaCaretDown />
                        </span>
                      </a>
                    </Link>
                  ...
                  <li className="header-nav-item">
                    <Link href="/abc">
                      <a>
                        Features <span className="icon header-icon-down"></span>
                      </a>
                    </Link>
                  </li>
                  <li className="header-nav-item">
                    <Link href="/abc">
                      <a>
                        Pricing <span className="icon header-icon-down"></span>
                      </a>
                    </Link>
                  </li>
                </ul>
